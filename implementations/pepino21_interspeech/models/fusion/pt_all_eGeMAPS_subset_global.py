...
This model uses a subset of Low Level Descriptors (LLDs) of eGeMAPS ([2]) and
...
class PreTrainedAllLayersSubsetOfLLDsGlobalNorm(nn.Module):
    """
    ...
    def __init__(self,
        ...
        """
        super(PreTrainedAllLayersSubsetOfLLDsGlobalNorm, self).__init__()
        ...
        self.pt_wise_conv1d_1_eGeMAPS = nn.Conv2d(
            in_channels=1,
            out_channels=dim1,
            kernel_size=(1, len(eGeMAPS_feat_idxs))
        )
