...
pre trained wav2vec2 as feature extractor, uses 12 transformer layers of
...
class PreTrainedContLayers(nn.Module):
    """
    Model as given in [1], using 12 transformer layers
    (without local encoder representations) of pre-trained wav2vec2
    """
    def __init__(self,
                 max_seq_len,
                 norm_means=None,
                 norm_std_devs=None):
        super(PreTrainedContLayers, self).__init__()
