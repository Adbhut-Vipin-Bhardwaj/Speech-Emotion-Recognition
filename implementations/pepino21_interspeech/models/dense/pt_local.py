...
pre trained wav2vec2 as feature extractor, uses the local encoding layer
...
class PreTrainedLocalLayer(nn.Module):
    """
    Model as given in [1], using local encoder representations
    of pre-trained wav2vec2
    """
    def __init__(self,
                 max_seq_len,
                 norm_means=None,
                 norm_std_devs=None):
        super(PreTrainedLocalLayer, self).__init__()
